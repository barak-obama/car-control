function scorchEx3(AI)
% First revised version - user parameters are set to default (wind - max
...
global params status tanks terrain tankmap isAI
...
function terrain = randterrain(params)
...
for i = 1:length(tanks)
  ...
  tanks{i}.maxpower = tanks{i}.maxpower - powerdrain;
